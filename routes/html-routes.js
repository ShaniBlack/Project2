...
module.exports = function(app) {
    ...
    //     // If the traveler already has an account send them to the members page
    //     if (req.traveler) {
    ...
    // // If a traveler who is not logged in tries to access this route they will be redirected to the signup page
    // app.get('/members', isAuthenticated, (req, res) => {
    //         res.sendFile(path.join(__dirname, '../public/members.html'))
    //     })
    //     // Each of the below routes just handles the HTML page that the traveler gets sent to.
